    ...
    <div id="app">
        <nav class="main-navbar">
            ...
            <div class="main-navbar-end">
                ...
                <el-tooltip content="Shoutbox" placement="bottom-end">
                    <a href="{{ route('shoutbox') }}" class="navbar-icon-link">
                        <el-icon style="font-size:1.4rem;"><chat-dot-round></chat-dot-round></el-icon>
                    </a>
                </el-tooltip>
                <!-- <el-tooltip content="Profile" placement="bottom-end"> -->
            ...
            <div :class="['main-navbar-collapse', { 'is-open': mobileMenuOpen }]">
                <el-menu mode="horizontal" :ellipsis="!mobileMenuOpen" style="width:100%;" class="main-navbar-items">
                    ...
                    <el-sub-menu index="admin">
                        ...
                        <el-menu-item index="admin-pages"><a href="{{ route('pages') }}"><el-icon><document></document></el-icon>&nbsp;Pages</a></el-menu-item>
                        ...
                        <el-menu-item index="admin-fp"><a href="{{ route('fpnicksearch') }}"><el-icon><search></search></el-icon>&nbsp;Fingerprint Search</a></el-menu-item>
                        <el-menu-item index="admin-sbdel"><a href="{{ route('sbdel.view') }}"><el-icon><chat-line-round></chat-line-round></el-icon>&nbsp;Deleted Shoutbox Messages</a></el-menu-item>
                        <el-menu-item index="admin-actions"><a href="{{ route('actions.view') }}"><el-icon><memo></memo></el-icon>&nbsp;Action-Log</a></el-menu-item>
                    </el-sub-menu>
                    @endif
                    @endauth
                    ...
                    <el-menu-item index="players"><a href="{{ route('player.all') }}"><el-icon><user-filled></user-filled></el-icon>&nbsp;Players</a></el-menu-item>
                    <el-menu-item index="registration"><a href="{{ route('registration') }}"><el-icon><calendar></calendar></el-icon>&nbsp;Registration</a></el-menu-item>
